...
```bash
npx @modelcontextprotocol/inspector --cli node dist/index.js arg1 arg2
```
...
npx @modelcontextprotocol/inspector \
  -e key=value \
  -e key2=$VALUE2 \
  --cli node dist/index.js arg1 arg2
```
...
```bash
npx @modelcontextprotocol/inspector --cli node dist/index.js 2>server.log
